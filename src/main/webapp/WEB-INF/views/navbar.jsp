...
<head>
    ...
    <title>AirConnect - Compagnie Aérienne</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link ${pageContext.request.requestURI.endsWith('index.jsp') ? 'active text-primary' : ''}" 
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#"><i class="fas fa-sign-in-alt me-2"></i>Connexion</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown ms-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr me-2"></i>Français</a></li>
                            <li><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-gb me-2"></i>English</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
